...
Die Einzelbilder können anschließend zu einem Film zusammengesetzt werden. Erinnern Sie sich an unsere Übung LUC.
}

# Aufgaben
1. Erstellen Sie eine Abbildung des mehrjährigen, mittleren Verlaufs der Feuerdynamik? Gehen Sie dabei  analog zur Hausaufgabenlösung des Phänologie Handouts vor. **(3 Punkte)**
