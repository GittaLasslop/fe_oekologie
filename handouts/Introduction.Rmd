...
---
# Überblick
Dieses Dokument bietet eine kurze Einführung in R und die Entwicklungsumgebung Rstudio. Sie sollen hierbei das Zusammenspiel aus Texteditor und Konsole in Rstudio lernen und einen Überblick über die verfügbaren Variablentypen in R bekommen. Desweiteren sollen Sie lernen wie Sie auf die in den Variablen abgespeicherten Werte zugreifen können.
...
Variablen speichern Werte, die wir ihnen zuweisen. In den folgenden Abschnitten werden wir wichtige Variablentypen einführen. Diese Unterscheiden sich in ihren Dimensionen und darin welche Werte darin abgespeichert werden. Daraus ergeben sich dann Unterschiede im Zugriff auf die darin abgespeicherten Werte und in der Verwendung der Variablen.
In R funktioniert das Zuweisen der Werte
durch die Zeichen "=" und "<-". Zwischen diesen beiden Zeichen gibt es keinen Unterschied für die Variablenzuweisung. 
