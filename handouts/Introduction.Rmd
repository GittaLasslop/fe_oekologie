...
Speichern Sie das 5. bis 8. Element der Variablen x in die Variable y1. Anschliessend speichern Sie das 2. sowie die Elemente 4 bis 6 in die Variable y2. Wie lautet das 3. Element in y2?
...
Erstellen Sie einen Funktion die ein Argument als Eingabe erwartet und folgende Funktionalität besitzt. Für Werte kleiner als 0 soll "ungültig", für Werte von 1-4 soll "sehr wenig", für Werte von 5-10 "wenig", für Werte von 10-100 "viel" und für alle Werte größer als 100 "sehr viel" zurückgegeben werden.
