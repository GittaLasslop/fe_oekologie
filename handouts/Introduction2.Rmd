...
download.file(urlfile,'data/intro2.zip')
unzip('data/intro2.zip)
```
...
3) Schreiben Sie eine Funktion zur Berechnung der Fläche eines Kreises names 'Kreisflaeche'. Eingabeparameter soll der Durchmesser sein. Rückgabewert soll die Fläche sein. Berechnen Sie durch einen Funktionsaufruf die Fläche eine Kreises mit Radius 1 und geben Sie das Ergebnis mit print() aus.
