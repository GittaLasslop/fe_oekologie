...
1) Lesen Sie die Daten aus der Datei ErsteDatencR.txt ein und fertigen Sie eine Abbildung der Zeitreihe der mittleren Temperatur an. Wandeln Sie hierfür das Datum mit Daten$Datum=as.POSIXct.Date(Daten$Datum) in den speziellen Datentyp für Zeit- und Datumvariablen um.
...
* beschriften Sie x- und y-Achse mit xlab und ylab
