...
6. Erstellen Sie eine Karte mit den Namen der Landbedeckungsklassen unseres Datenausschnitts und den Umrissen von Australien.**(2 Punkte)**  (siehe im skript mapPhen das Beispiel für Deutschland)
