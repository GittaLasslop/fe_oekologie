...
2.  In dem Skript wird das Verhältnis Wald zu nicht Wald in einem kleinem Ausschnitt betrachtet. Überlegen Sie sich eine eigene Klassifizierung (Urbanisierung, Landwitschaft, Verbuschung, ...) Ihrer Region und passen Sie die Variablennamen und die Klassifizierung entsprechend an. Eventuell muss auch der zu benutzende Ausschnitt verändert werden (forestExtent), damit zum Beispiel eine Stadt enthalten ist.
