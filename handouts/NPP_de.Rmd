...
```
Download der Daten von https://powerfolder.gwdg.de/filestable/MjRGYXU2YUViNThFdU5yMlFhZXV2, die entpackten Dateien sollen in folgendem Verzeichnis liegen.
...
Laden der Landnutzungsklassen, anhand welcher die NPP-Werte klassifiziert werden. (Die Daten müssen Sie eventuell noch runterladen.) Die LCT3lookuptable müssen Sie wie in der letzten Stunde einlesen.
...
1. Änderen Sie die Farbgebung analog zu den vorherigen Skripten. **(1 Punkt)**

2. Machen Sie das gleiche für Land Cover Type 1. **(2 Punkte)**

3. Es gibt auch eine entsprechende GPP Datei (Brutto-Primärproduktion). Machen Sie das gleiche für LCT1, LCT3 und GPP. (3 Punkte)

4. Setzen Sie NPP ins Verhältnis zu GPP.
    + Erzeugen Sie eine Karte des Verhältnisses NPP:GPP (1 Punkt)
    + Erzeugen Sie einen Boxplot des Verhältnisses von NPP:GPP pro Ökosystem (1 Punkt)
