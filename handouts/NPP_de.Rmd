...
2. Was bewirkt der Befehl *coord_flip()*? **(1 Punkt)**

3. Wie können Sie die Zahl 2.7645 auf zwei Nachkommastellen runden? **(1 Punkt)**

4. Es gibt auch eine entsprechende GPP Datei (Brutto-Primärproduktion). Machen Sie das gleiche für GPP. **(2 Punkte)**

5. Erstellen Sie eine Karte von NPP. **(1 Punkt)**

6. Setzen Sie NPP ins Verhältnis zu GPP.
    + Erzeugen Sie eine Karte des Verhältnisses NPP:GPP **(1 Punkte)**
