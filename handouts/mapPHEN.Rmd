...
Da in diesem Fall die Ländergrenzen mit abgebildet werden muss noch angegeben werden welche Punkte zu einem Land gehören. Diese Information ist in der Variablen "group" hinterlegt. Im nächsten Schritt wird ein Geom zum Plotobject `p` hinzugefügt, in diesem Fall sind das die Ländergrenzen als Linien. Man könnte auch noch weitere Schichten von Geomen hinzufügen. In diesem Beispiel werden mit den nächsten Befehlen nur noch die Beschriftungen angepasst.
