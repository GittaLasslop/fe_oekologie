...
fileName <- paste0("LUC_", getOption("fegloekRegion"), 
                   ".zip")
#file='https://www.dropbox.com/sh/1rcz0fjmgz2hnuh/
#AABBwtgJHlcD21y5t43NFLpma/Daten/LUC_ALASKA.zip?dl=0'
#oder
file=
  'https://powerfolder.gwdg.de/dl/fiXNVFhCv7bwzo33Hj8Rys5L/LUC_ALASKA.zip'
