...
-------------------------------------
**Aufgabe**
Schauen Sie sich sich Variablen mit den Befehlen 'head()' und 'str()' an, um zu verstehen, 
...
über die Abbildung.  
Setzen Sie als Ueberschrift über die Legende den Text 'Land cover types'. 
